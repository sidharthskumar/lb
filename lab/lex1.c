...
int validIdentifier2(char* str)
{
    ...
    if (str[i] == '@' || str[i] == '#' || str[i] == '%' ||
        str[i] == '&' || str[i] == '%' || str[i] == '(' ||  isDelimiter(str[i]) == 1)
        return 0;
}
    return 1;
}
...
printf("<'%s',literal>\n", subStr);
         else if (((validIdentifier(subStr) == 1) && (validIdentifier2(subStr) == 1)) && (isDelimiter(str[right - 1]) == 0) )
{//printf("<'%c',identifier>\n", subStr[0]);
//printf("%d\n",left);;
//printf("%d\n",right);
//printf("<'%c',identifier>\n", subStr[right - 1]);
printf("<'%s',identifier>\n", subStr);
          ...
          else if ((validIdentifier(subStr) == 0 ||(validIdentifier2(subStr) == 0) )&& isDelimiter(str[right - 1]) == 0) {
